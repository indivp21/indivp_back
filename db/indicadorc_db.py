...
database_indicadores = {
	...
	"Indicador13": IndicadorInDB(**{"id_indicador": 13,
							...
							"calculo":"2717 *1 / 2748",
							"comentario":"Indicador mensual transmitido por la Gerencia de calidad de Servicio (Resultado corresponde a cierre Agosto)",
							"ponderado":99,
							"lgreen":98,
							"lyellow":"95",
							"lred":95}),
	...
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"(331+125)/(331+4354)",
							"comentario":"Acreedores mensuales que se generan posterior a la aplicación de pagos, se aplican reintegros a los titulares con cuentas del Banco o externas, o a través de oficinas  durante el mes, se monitorea el total generado versus lo reintegrado. El indicador",
							"ponderado":99.5,
							"lgreen":90,
							"lyellow":"95",
							"lred":95}),
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"calculo":"26426/(26426+219)",
							"comentario":"Indicador se registra una vez al mes, las aplicaciones se realizan antes del vencimiento de los convenios. No se incluyen rechazos de pagaduría de ministerio de defensa, dado que son 1274 obligaciones dpendientes de pago. Se aplican con FE por DUC ta",
							"ponderado":100.0,
							"lgreen":98,
							"lyellow":"95",
							"lred":95}),
	...
	"Indicador16": IndicadorInDB(**{"id_indicador": 16,
							...
							"calculo":"39 / (38 + 1)",
							"comentario":"Indicadores con corte al jueves 8 de julio, en razón a que el cierre del sistema se realiza el viernes al finalizar la operación",
							"ponderado":98.2,
							"lgreen":98,
							"lyellow":"97",
							"lred":97}),
	"Indicador17": IndicadorInDB(**{"id_indicador": 17,
							...
							"calculo":"298 / (283 + 15)",
							"comentario":"Indicadores con corte al jueves 8 de julio, en razón a que el cierre del sistema se realiza el viernes",
							"ponderado":100.0,
							"lgreen":98,
							"lyellow":"97",
							"lred":97}),
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"1*(637/638)",
							"comentario":"Se presentó rechazo en la creación una obligación de Vehigrupo el 01 de octubre por inconsistencia en el archivo de clientes enviado por la originadora.",
							"ponderado":100.0,
							"lgreen":95,
							"lyellow":"90",
							"lred":90}),
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"12.053 / 36.421",
							"comentario":"Informe con corte septiembre 30 de 2021. Se adelanta plan de Acción para depuración de partidas antiguas,  originadas  en aplicación de medidas de acompañamiento a deudores  mediante la creación  de cargos en los Sistemas Core, con incidencias por fa",
							"ponderado":100.0,
							"lgreen":90,
							"lyellow":"80",
							"lred":80}),
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"",
							"comentario":"El Indicador es mensual  con corte  Agosto porque es el  conciliado con custodios. A corte Septiembre en curso Resultado es el promedio de lo corrido del año",
							"ponderado":100.0,
							"lgreen":99,
							"lyellow":"98",
							"lred":98}),
	"Indicador8": IndicadorInDB(**{"id_indicador": 8,
							...
							"calculo":"(580/580)+(8/580) Notaria  62  (571/571)+ (8/571) Notaria  51",
							"comentario":"Indicador  de oportunidad y calidad  del  1  al 30 Sept Resultado es el promedio de lo corrido del  año",
							"ponderado":100.0,
							"lgreen":99,
							"lyellow":"98",
							"lred":98}),
	"Indicador28": IndicadorInDB(**{"id_indicador": 28,
							...
							"calculo":"291*1/291",
							"comentario":"El Indicador es mensual con corte  Septiembre Resultado es el promedio de lo corrido del año",
							"ponderado":99.9,
							"lgreen":99,
							"lyellow":"98",
							"lred":98}),
