...
database_indicadores = {
	...
	"Indicador14": IndicadorInDB(**{"id_indicador": 14,
							...
							"calculo":"128 / ( 128 +0 )",
							"comentario":"Indicadores con corte al jueves 22 de abril, en razón a que el cierre del sistema se realiza el viernes al finalizar la operación, por lo tanto no es posible obtener informción al corte del viernes",
							"ponderado":100.0,
							"lgreen":98,
							"lyellow":"97",
							"lred":97}),
	...
	"Indicador21": IndicadorInDB(**{"id_indicador": 21,
							...
							"comentario":"Una parte del indicador tiene componente mensual se mantiene con la información de la semana anterior",
							"ponderado":100.0,
							"lgreen":95,
							"lyellow":"80",
							"lred":80}),
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"1*(1061/1222)",
							"comentario":"Para la compra de cartera del 27 de abril a Refinancia Satr Clientes generó rechazo para la creación 161 clientes; se reprocesó el 28 de abril quedando todos creados.",
							"ponderado":95.7,
							"lgreen":95,
							"lyellow":"90",
							"lred":90}),
	...
	"Indicador26": IndicadorInDB(**{"id_indicador": 26,
							...
							"calculo":"0",
							"comentario":"El Indicador mensual  con corte Marzo   Resultado  es el promedio del año  2022",
							"ponderado":100.0,
							"lgreen":99,
							"lyellow":"98",
							"lred":98}),
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"(81/81)+(0/81) Notaria  62  (120/120)+(3/120) Notaria  51",
							"comentario":"Los valores corresponden  a la semana del 18 al 22 de abril Resultado  es el  promedio del año 2022",
							"ponderado":99.2,
							"lgreen":99,
							"lyellow":"98",
							"lred":98}),
	...
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"8.129/23.966",
							"comentario":"Informe con corte Abril 22  de 2022,  Actualmente el area se encuentra trabajando un plan de Acción  en proceso de depuración de las partidas antiguas, producto de la implementación de estrategias para atender Emergencia Sanitaria y negociaciones de",
							"ponderado":51.2,
							"lgreen":90,
							"lyellow":"80",
							"lred":80}),
