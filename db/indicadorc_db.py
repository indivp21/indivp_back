...
database_indicadores = {
	...
	"Indicador14": IndicadorInDB(**{"id_indicador": 14,
							...
							"calculo":"43 / ( 43 +0 )",
							"comentario":"Indicadores con corte al jueves 15 de septiembre, en razón a que el cierre del sistema se realiza el viernes al finalizar la operación, por lo tanto no es posible obtener informción al corte del viernes",
							"ponderado":100.0,
							"lgreen":98,
							"lyellow":"97",
							"lred":97}),
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"(133/133)+(0/133) Notaria  62  (175/175)+(0/175) Notaria  51",
							"comentario":"los valores corresponden  del 1 al 9 de  Septiembre Resultado  es el promedio del año  2022",
							"ponderado":99.8,
							"lgreen":99,
							"lyellow":"80",
							"lred":80}),
	"Indicador21": IndicadorInDB(**{"id_indicador": 21,
							...
							"calculo":"238/238",
							"comentario":"El Indicador es mensual con corte  Agosto Resultado es el promedio del año 2022",
							"ponderado":100.0,
							"lgreen":99,
							"lyellow":"90",
							"lred":90}),
	"Indicador22": IndicadorInDB(**{"id_indicador": 22,
							...
							"formula":"Requerimientos atendidos oportunamente * 1 / Total de requerimientos a solucionar",
							"calculo":"851*1/860",
							"comentario":"Indicador mensual transmitido por la Gerencia de calidad de Servicio  con corte Agosto Resultado es el promedio del año 2022",
							"ponderado":99.6,
							"lgreen":99,
							"lyellow":"90",
							"lred":90}),
	...
	"Indicador23": IndicadorInDB(**{"id_indicador": 23,
							...
							"comentario":"Una parte del indicador es mensual, el cual se actualiza con la información de la presente semana",
							"ponderado":100.0,
							"lgreen":95,
							"lyellow":"99.3",
							"lred":99.3}),
	...
	"Indicador8": IndicadorInDB(**{"id_indicador": 8,
							...
							"calculo":"1*((389)/(390))",
							"comentario":"En la compra de cartera a Refinancia del 15 de septiembre, quedó una obligación sin crear, por inconvenientes en las interface que viaja a Star Clientes.",
							"ponderado":99.7,
							"lgreen":95,
							"lyellow":"80",
							"lred":80}),
	...
	"Indicador28": IndicadorInDB(**{"id_indicador": 28,
							...
							"comentario":"Indicador mensual se actualiza con la información de la presente semana",
							"ponderado":94.9,
							"lgreen":100,
							"lyellow":"98",
							"lred":98}),
