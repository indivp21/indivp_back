...
database_indicadores = {
	...
	"Indicador14": IndicadorInDB(**{"id_indicador": 14,
							...
							"calculo":"73 / ( 73 +0 )",
							"comentario":"Indicadores con corte al jueves 10 de noviembre, en razón a que el cierre del sistema se realiza el viernes al finalizar la operación, por lo tanto no es posible obtener informción al corte del viernes",
							"ponderado":100.0,
							"lgreen":98,
							"lyellow":"97",
							"lred":97}),
	...
	"Indicador8": IndicadorInDB(**{"id_indicador": 8,
							...
							"calculo":"(85/85)+(0/85) Notaria  62  (78/78)+(3/78) Notaria  51",
							"comentario":"los valores corresponden  del 1 al  4 de Noviembre  Resultado  es el promedio del año  2022",
							"ponderado":99.7,
							"lgreen":99,
							"lyellow":"80",
							"lred":80}),
	"Indicador21": IndicadorInDB(**{"id_indicador": 21,
							...
							"calculo":"194/194",
							"comentario":"El Indicador es mensual con corte  Octubre  Resultado es el promedio del año 2022",
							"ponderado":100.0,
							"lgreen":99,
							"lyellow":"90",
							"lred":90}),
	"Indicador22": IndicadorInDB(**{"id_indicador": 22,
							...
							"formula":"Requerimientos atendidos oportunamente * 1 / Total de requerimientos a solucionar",
							"calculo":"742*1/744",
							"comentario":"Indicador mensual transmitido por la Gerencia de calidad de Servicio  con corte Octubre Resultado es el promedio del año 2022",
							"ponderado":99.4,
							"lgreen":99,
							"lyellow":"90",
							"lred":90}),
	"Indicador9": IndicadorInDB(**{"id_indicador": 9,
							...
							"calculo":"(585.511/585.793 ) Colmena Deudores (158.351/162.162) Liberty",
							"comentario":"Indicador  de oportunidad y calidad a Septiembre de 2022 Resultado es el promedio  del  año 2022",
							"ponderado":99.5,
							"lgreen":99,
							"lyellow":"90",
							"lred":90}),
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"1*(6/7)",
							"comentario":"Los recaudos del 08 de noviembre autorizados para aplicar el 10 de noviembre, quedaron aplicados el 11 de noviembre; por error de la Central de Consolidación y Cuadre.",
							"ponderado":97.9,
							"lgreen":95,
							"lyellow":"98",
							"lred":98}),
	"Indicador28": IndicadorInDB(**{"id_indicador": 28,
							...
							"comentario":"Indicador mensual se actualiza con las transmisiones de la presente semana",
							"ponderado":95.4,
							"lgreen":100,
							"lyellow":"98",
							"lred":98}),
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"calculo":"8187/8663",
							"comentario":"Informe con corte a Octubre 31 del 2022 , el indicador  mejora con respecto al enviado la semana anterior,  efecto del avance en la  depuración de partidas  antiguas , que involucran la creación  de cargos en los aplicativos, los cuales presentan inc",
							"ponderado":71.4,
							"lgreen":90,
							"lyellow":"98",
							"lred":98}),
