...
database_indicadores = {
	...
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							"name":"Adquirencia Habilitación Establecimientos de Comercio",
							"porcentaje":22,
							"gerencia":"Gerencia Operativa Red de Oficinas",
							"central": "RED de Oficinas",
							"colorin":"1. Red",
							"formula":"Variación semanal: 100-((Semana anterior*100)/Semana Actual))",
							"calculo":"36 para semana del 24 al 30 - 44 para la semana del 01 al 07",
							"comentario":"36 para semana del 24 al 30 - 44 para la semana del 01 al 07",
							"ponderado":22,
							"lgreen":22,
							"lyellow":"N/A",
							"lred":21}),
