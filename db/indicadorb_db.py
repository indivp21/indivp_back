...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.246.465 // reclamos radicados parcial Enero 1209",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"482 Casos por vencer // 02 casos vencidos // 06 casos prorrogados. Solucionadores 29 DAR y 14 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 41.398 // llamadas atendidas 38.567",
							"comentario":"Se mantuvo volumen alto de llamadas, producto de puente festivo, incidencias y temas de impacto, afectacion por incidencia en terminal RDS y ausencias en la operación.",
							"ponderado":96.2,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 1.872 // llamadas atendidas 1.811",
							"comentario":"",
							"ponderado":91.6,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 4.727  // llamadas atendidas 4.565",
							"comentario":"",
							"ponderado":97.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.591 // Chat atendidos 4.574",
							"comentario":"",
							"ponderado":99.6,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 04 presentaron incidencia, para un total 1025 hrs 36 min.",
							"comentario":"Aplicativos con mas bajo desempeño: BACKBASE 0%  // SARE 75%. La terminal RDS tambien se vio afectada en 12 hrs 35 seg.",
							"ponderado":66.7,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
