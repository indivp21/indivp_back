...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.237.174 // reclamos parcial diciembre radicados 1.006",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"621 Casos por vencer // 01 casos vencidos // 04 casos prorrogados. Solucionadores 29 DAR y 08 áreas descentralizadas.",
							"comentario":"Top 3 de la semana: 1. NM - Revisión comportamiento y/o condiciones del crédito. 2. NM -Debitó y no Pagó o Entrega parcial de efectivo ATM Otras Redes. 3. NM - Debitó y no Pagó o Entrega parcial de efectivo ATM Propio.",
							"ponderado":96.8,
							"lgreen":98,
							"lyellow":"N/A",
							"lred":98}),
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 43.355 // llamadas atendidas 41.067",
							"comentario":"Incremento alto de llamadas, varias incidencias y temas de impacto, a su vez se presentan ausencias en la operacion cada día.",
							"ponderado":96.5,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.085 // llamadas atendidas 1.989",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 5.597 // llamadas atendidas 5.355",
							"comentario":"Sin información",
							"ponderado":98.2,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.315 // Chat atendidos 4.301",
							"comentario":"Sin información",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 08 presentaron incidencia, para un total 1364 hrs 44 min.",
							"comentario":"Aplicativos con mas bajo desempeño: SAPRO 47% // BACKBASE 0%. La terminal RDS tambien se vio afectada en 09 hrs 55 min.",
							"ponderado":71.9,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
