...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.267.228 // reclamos radicados parcial Marzo 379",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"879 Casos por vencer // 00 casos vencidos //  05 casos prorrogados. Solucionadores 37 DAR y 23 áreas descentralizadas.",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"calculo":"Llamadas recibidas 71.814 // llamadas atendidas 54.417",
							"comentario":"Volúmenes altos de llamadas por cierre y comienzo de mes, temas de impacto, lentitud en RDS, incidencias en aplicativos del banco y adicional a esto incidencia en pagina transaccional.",
							"ponderado":94.7,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 7.943 // llamadas atendidas 3.597",
							"comentario":"Estamos en atención de la linea empresarial para renovación de Token, se tiene volumen alto de llamadas, superando asi nuestra capacidad instalada y generando un alto numero de abandonos.",
							"ponderado":89.2,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 7.400  // llamadas atendidas 5.995",
							"comentario":"Seguimos con altos volúmenes de llamadas debido a proceso de renovación de dispositivo y algunas otros volúmenes de llamadas referentes al proceso de desbloqueo y activación de token, así como llamadas referentes a pagos de nómina y proveedores.",
							"ponderado":97.0,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 06 presentaron incidencia, para un total 1246 hrs 52 min.",
							"comentario":"Aplicativos con mas bajo desempeño: BACKBASE 0% // PORTAL INTRANET 0% // STAR SET 0%. Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 58 hrs 36 min.",
							"ponderado":59.7,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
