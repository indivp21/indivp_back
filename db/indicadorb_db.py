...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.361.338 // reclamos radicados corte octubre 536",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"calculo":"621 Casos por vencer // 00 casos vencidos //  00 casos prorrogados. Solucionadores 27 DAR y 13 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 59.651 // llamadas atendidas 55.233",
							"comentario":"Incremento de llamadas cierre y comienzo de mes, Temas de Impacto e incidencias varias en RDS, entre otras.",
							"ponderado":94.1,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 3.724 // llamadas atendidas 3.569",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 6.220 // llamadas atendidas 5.879",
							"comentario":"Incremento de llamadas comienzo de mes y ausencias en personal, superando capacidad de atención",
							"ponderado":96.9,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.714 // Chat atendidos 4.680",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 09 presentaron incidencia, para un total 714 hrs 30 min.",
							"comentario":"Aplicativos con mas bajo desempeño:  STAR SET 0% // B-BACKBASE 0% // OPENCARD TC  31% Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 26 hrs 40 min.",
							"ponderado":61.6,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
