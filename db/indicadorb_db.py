...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.361.338 // reclamos radicados corte septiembre 1505",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"calculo":"726 Casos por vencer // 00 casos vencidos //  00 casos prorrogados. Solucionadores 28 DAR y 12 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 47.262 // llamadas atendidas 45.908",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.872 // llamadas atendidas 2.813",
							"comentario":"Sin informacion",
							"ponderado":91.5,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 5.962 // llamadas atendidas 5.879",
							"comentario":"Sin informacion",
							"ponderado":96.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.551 // Chat atendidos 4.542",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 11 presentaron incidencia, para un total 878 hrs 55 min.",
							"comentario":"Aplicativos con mas bajo desempeño:  STAR SET 0% // B-BACKBASE 0% // ICS 20% Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 17 hrs 22 min.",
							"ponderado":60.7,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
