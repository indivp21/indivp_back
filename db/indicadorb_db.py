...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.237.174 // reclamos parcial diciembre radicados 1.741",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"747 Casos por vencer // 02 casos vencidos // 04 casos prorrogados. Solucionadores 32 DAR y 08 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 57.065 // llamadas atendidas 52.055",
							"comentario":"Alto flujo de llamadas por quincenas, prima navideña, incidencias y temas de impacto, tambien se presentaron varias ausencias en la operación.",
							"ponderado":96.2,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.922 // llamadas atendidas 2.776",
							"comentario":"",
							"ponderado":90.7,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 7.909 // llamadas atendidas 7.243",
							"comentario":"Alto flujo de llamadas, temas de impacto y ausencias en la operación.",
							"ponderado":97.8,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 5.996 // Chat atendidos 5.961",
							"comentario":"",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 08 presentaron incidencia, para un total 1661 hrs 27 min.",
							"comentario":"Aplicativos con mas bajo desempeño: BACKBASE 0%  // Control y Seguimiento 15%. La terminal RDS tambien se vio afectada en 20 hrs 05 min.",
							"ponderado":69.6,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
