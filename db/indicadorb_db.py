...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.222.998 // reclamos parcial noviembre radicados 1.843",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"calculo":"661 Casos por vencer // 1 casos vencidos // 07 casos prorrogados. Solucionadores 21 DAR y 07 áreas descentralizadas.",
							"comentario":"Top 3 de la semana: 1. NM - Revisión comportamiento y/o condiciones del crédito. 2. NM -Debitó y no Pagó o Entrega parcial de efectivo ATM Otras Redes. 3. NM - Habeas Data.",
							"ponderado":96.8,
							"lgreen":98,
							"lyellow":"N/A",
							"lred":98}),
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 43.070 // llamadas atendidas 41.239",
							"comentario":"",
							"ponderado":96.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.512 // llamadas atendidas 2.339",
							"comentario":"",
							"ponderado":90.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 5.073 // llamadas atendidas 4.998",
							"comentario":"",
							"ponderado":98.6,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 2.937 // Chat atendidos 2.932",
							"comentario":"",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 04 presentaron incidencia, para un total 904 hrs 01 min.",
							"comentario":"Aplicativos con mas bajo desempeño: SAPRO 84% // BACKBASE 91%. La terminal RDS tambien se vio afectada en 10 hrs 31 min.",
							"ponderado":74.5,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
