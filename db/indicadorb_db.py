...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.349.262 // reclamos radicados corte septiembre 891",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"calculo":"641 Casos por vencer // 00 casos vencidos //  00 casos prorrogados. Solucionadores 28 DAR y 13 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 53.281 // llamadas atendidas 50.161",
							"comentario":"Incidencias, temas de impacto y afectacion terminal RDS.",
							"ponderado":93.8,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 3.054 // llamadas atendidas 2.969",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 6.430 // llamadas atendidas 6.142",
							"comentario":"Sin informacion",
							"ponderado":96.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.776 // Chat atendidos 4.732",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 08 presentaron incidencia, para un total 843 hrs 43 min.",
							"comentario":"Aplicativos con mas bajo desempeño:  STAR SET 0% // B-BACKBASE 0% // MANTIZ 31% Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 15 hrs 59 min.",
							"ponderado":60.6,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
