...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.341.958 // reclamos radicados Julio 1.808",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"557 Casos por vencer // 00 casos vencidos //  01 casos prorrogados. Solucionadores 28 DAR y 13 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 43.604 // llamadas atendidas 40.906",
							"comentario":"Se presentó incidencias en apllcativos e inconsistencia en terminal RDS.",
							"ponderado":93.6,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.493 // llamadas atendidas 2.446",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 5.345 // llamadas atendidas 5.236",
							"comentario":"Sin informacion",
							"ponderado":96.8,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 3.866 // Chat atendidos 3.865",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 08 presentaron incidencia, para un total 879 hrs 17 min.",
							"comentario":"Aplicativos con mas bajo desempeño:  STAR SET 0% // SARE 70 % Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 8 hrs 50 min.",
							"ponderado":57.1,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
