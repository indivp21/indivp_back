...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.312.830 // reclamos radicados parcial Abril 1766",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"483 Casos por vencer // 00 casos vencidos //  02 casos prorrogados. Solucionadores 33 DAR y 17 áreas descentralizadas.",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 41.198 // llamadas atendidas 39.953",
	...
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 2.190 // llamadas atendidas 2.151",
							"comentario":"Sin informacion",
							"ponderado":89.5,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 4.934  // llamadas atendidas 4.853",
							"comentario":"Sin informacion",
							"ponderado":98.3,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.137 // Chat atendidos 4.124",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 09 presentaron incidencia, para un total 1507 hrs 05 min.",
							"comentario":"Aplicativos con mas bajo desempeño: VPR CREDITO 5.0 0% // PORTAL INTRANET 0% // SAPRO 50%. Importante mencionar que variasTX Admtivas se vieron muy afectadas. La terminal RDS tambien se vio afectada en 3 hrs 47 min.",
							"ponderado":73.8,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
