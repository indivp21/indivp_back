...
database_indicadores = {
	"Indicador1": IndicadorInDB(**{"id_indicador": 1,
							...
							"calculo":"Clientes Activos 2.378.116 // reclamos radicados corte diciembre 113",
							"comentario":"El número de clientes activos tomado del mes de Octubre, pendiente por actualización desde la GCS.",
							"ponderado":0.8,
							"lgreen":1.1,
							"lyellow":"N/A",
							"lred":1.1}),
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"539 Casos por vencer // 00 casos vencidos //  01 casos prorrogados. Solucionadores 29 DAR y 9 áreas descentralizadas.",
							"comentario":"Top 3 de la semana: 1. NM - Debitó y no Pagó o Entrega parcial de efectivo ATM Propio 2. NM - Revisión comportamiento y/o condiciones del crédito 3. NM - Revisión comportamiento y/o condiciones en cuenta",
							"ponderado":98.5,
							"lgreen":98,
							"lyellow":"N/A",
							"lred":98}),
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Llamadas recibidas 54.330 // llamadas atendidas 49,968",
							"comentario":"Incidencias varias en RDS, entre otras e incremento de llamadas fin de mes..",
							"ponderado":94.1,
							"lgreen":95,
							"lyellow":"N/A",
							"lred":95}),
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 3.200 // llamadas atendidas 2.984",
	...
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"colorin":"1. Red",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Llamadas recibidas 6.060 // llamadas atendidas 5.719",
							"comentario":"Sin informacion",
							"ponderado":96.9,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"colorin":"3. Green",
							"formula":"# casos redicados / # casos atendidos",
							"calculo":"Chat recibidos 4.371 // Chat atendidos 4.360",
							"comentario":"Sin informacion",
							"ponderado":99.5,
							"lgreen":92,
							"lyellow":"N/A",
	...
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"calculo":"Total aplicativos 19 // 07 presentaron incidencia, para un total 438 hrs 57 min.",
							"comentario":"Aplicativos con mas bajo desempeño:  SOS.NET 24% // TX Administrativas puntuales 35% y STAR SET - (Antes ACME) en 50%. La terminal RDS tambien se vio afectada en 12 hrs 55 min..",
							"ponderado":61.3,
							"lgreen":99,
							"lyellow":"N/A",
							"lred":99}),
