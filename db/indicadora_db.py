...
database_indicadores = {
	...
	"Indicador15": IndicadorInDB(**{"id_indicador": 15,
							...
							"calculo":"Información suministrada por el aliado Carvajal cierre Octubre: La información es generada por assenda red, el monitoreo realizado en el mes sobre la VPN, la plataforma transaccional, ventanas programadas y incidencias presentadas. No presentó afecta",
							"comentario":"97,00%",
							"ponderado":,
							"lgreen":98,
							"lyellow":"97.6",
