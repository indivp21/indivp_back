...
database_indicadores = {
	"Indicador5": IndicadorInDB(**{"id_indicador": 5,
							...
							"comentario":"up time semanal del 18 al 24 de agosto",
							"ponderado":97.2,
							"lgreen":97,
							"lyellow":"N/A",
							"lred":97}),
	"Indicador2": IndicadorInDB(**{"id_indicador": 2,
							...
							"comentario":"up time semanal del 18 al 24 de agosto - las fallas de máquina y la baja gestión del proveedor continuan y no se observa mejoría en la semana - se realizan reuniones con el proveedor para validar situaciones específicas de la operación.",
							"ponderado":96.3,
							"lgreen":97,
							"lyellow":"N/A",
							"lred":97}),
	...
	"Indicador10": IndicadorInDB(**{"id_indicador": 10,
							...
							"calculo":"Saldo promedio: $659.873.534.184",
							"comentario":"Semana 18 al 24 de Agosto 2022",
							"ponderado":98.9,
							"lgreen":100,
							"lyellow":"97",
							"lred":97}),
	"Indicador11": IndicadorInDB(**{"id_indicador": 11,
							...
							"calculo":"Lotes aplicados: 33.129                                                       Valor Total $504.767.637.998.94",
							"comentario":"Semana del 19 al 25 de agosto",
							"ponderado":99.4,
							"lgreen":100,
							"lyellow":"90",
							"lred":90}),
	"Indicador12": IndicadorInDB(**{"id_indicador": 12,
							...
							"calculo":"Centrales de Canje: 38. 8 Cedec, 17 CUD o delegadas teercerizadas y 13 propias delegadas. Valor Canje Rec.: $102.443.759.436.31 Valor Canje Env.: $70.521.041.330.35",
							"comentario":"Semana del 17 al 23 de agosto",
							"ponderado":100.0,
							"lgreen":100,
							"lyellow":"N/A",
							"lred":100}),
	"Indicador8": IndicadorInDB(**{"id_indicador": 8,
							...
							"calculo":"Identificaciones Capturadas 49.448 Identificaciones Oportunas (1-3 dias)  49.307 Identificaciones Inoportunas (4 ó mas dias )  97 Identificaciones Pendientes 44",
							"comentario":"Semana del 15 al 21 agosto del 2022",
							"ponderado":96.7,
							"lgreen":96,
							"lyellow":"92",
							"lred":92}),
	"Indicador4": IndicadorInDB(**{"id_indicador": 4,
							...
							"calculo":"349 (# casos asignados en Service Now)",
							"comentario":"Semana del 19 al 25 de agosto",
							"ponderado":85.2,
							"lgreen":100,
							"lyellow":"76",
	...
	"Indicador3": IndicadorInDB(**{"id_indicador": 3,
							...
							"calculo":"Op. Recibidas de clientes 342 Op. Cumplidas 316 por valor de USD 2,915,157,20",
	...
	"Indicador13": IndicadorInDB(**{"id_indicador": 13,
							...
							"calculo":"7.157 puntos conciliados 5.993 ajustes aplicados",
							"comentario":"Semana del 19  al 25 de agosto",
							"ponderado":99.3,
							"lgreen":100,
							"lyellow":"90",
	...
	"Indicador9": IndicadorInDB(**{"id_indicador": 9,
							...
							"calculo":"19 por $ 10.439.449 corte julio 31 de 2.022",
							"comentario":"Semana del 19  al 25 de agosto",
							"ponderado":98.6,
							"lgreen":90,
							"lyellow":"N/A",
	...
	"Indicador7": IndicadorInDB(**{"id_indicador": 7,
							...
							"calculo":"SEMANAL     Q  1,122    $ 524.089  Miles Mll",
							"comentario":"Semana del 19  al 25 de agosto",
							"ponderado":96.9,
							"lgreen":95,
							"lyellow":"N/A",
	...
	"Indicador6": IndicadorInDB(**{"id_indicador": 6,
							...
							"calculo":"=1-(4193/165763)",
							"comentario":"Se detalla los rechazos operacionales de transaccionalidad en el canal, donde el mayor volumen o relevancia no son atribuibles a fallas del canal, sin embargo, se presentaron 133  trx con error inesperado en consulta: TRXW2 W2- FONDOS INSUFICIENTES P",
							"ponderado":99.8,
							"lgreen":95,
							"lyellow":"93",
							"lred":93}),
